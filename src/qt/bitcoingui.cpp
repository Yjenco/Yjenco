...
{   
    ...
    setWindowTitle(tr("Yjenco") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/yjenco"));
    setWindowIcon(QIcon(":icons/yjenco"));
#else
    ...
    novaexchangePage = new NovaExchange(this);
    ...
    centralWidget->addWidget(novaexchangePage);
...
void BitcoinGUI::createActions()
{
    ...
    bitcointalkAction = new QAction(QIcon(":/icons/yjenco"), tr("&Bitcointalk"), this);
    ...
    twitterAction = new QAction(QIcon(":/icons/yjenco"), tr("&Twitter"), this);
    ...
    bittrexAction = new QAction(QIcon(":/icons/yjenco"), tr("&Bittrex"), this);
    ...
    novaexchangeAction = new QAction(QIcon(":/icons/yjenco"), tr("&NovaExchange"), this);
    novaexchangeAction->setToolTip(tr("NovaExchange"));
    novaexchangeAction->setCheckable(true);
    novaexchangeAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(novaexchangeAction);

    yobitAction = new QAction(QIcon(":/icons/yjenco"), tr("&Yobit"), this);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Yjenco address"));
    ...
    connect(novaexchangeAction, SIGNAL(triggered()), this, SLOT(gotoNovaExchangePage()));
    connect(novaexchangeAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Yjenco"), this);
    aboutAction->setToolTip(tr("Show information about Yjenco"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo-64"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Yjenco"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenu *overview = appMenuBar->addMenu(tr("&Balance"));
    ...
    trade->addSeparator();
    trade->addAction(novaexchangeAction);
    trade->addSeparator();
...
//    toolbar->addAction(novaexchangeAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Yjenco client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Yjenco client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Yjenco network", "", count));
}
...
void BitcoinGUI::gotoNovaExchangePage()
{
    novaexchangeAction->setChecked(true);
    centralWidget->setCurrentWidget(novaexchangePage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Yjenco address or malformed URI parameters."));
    }
