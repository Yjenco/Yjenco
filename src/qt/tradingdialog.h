...
private slots:
    ...
    void on_BuyYNC_clicked();
    void on_SellYNCBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputYNC_textChanged(const QString &arg1);
    ...
    QString BuyYNC(QString OrderType, double Quantity, double Rate);
    QString SellYNC(QString OrderType, double Quantity, double Rate);
