...
!define COMPANY "Yjenco Coin"
!define URL http://www.yjenco.co,uk/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/yjenco.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\yjenco-qt.exe
...
OutFile yjenco-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/yjenco-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/yjencod.exe
    ...
    #Delete /REBOOTOK $INSTDIR\yjenco.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\yjenco-qt.exe
